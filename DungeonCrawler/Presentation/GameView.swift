...
struct GameView: NSViewRepresentable {
    ...
    fileprivate func createCube(worldPosition: SIMD3<Float>) -> AnchorEntity {
    ...
    fileprivate func addFloorAndCeiling(_ arView: ARView) {
        ...
        let ceilingEntity = ModelEntity(mesh: .generatePlane(width: 10, depth: 10), materials: [ceilingMaterial])
